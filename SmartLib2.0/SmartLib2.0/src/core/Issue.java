...
public class Issue extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // Update the Borrowed Books amount for particular Borrower
        final String SQL_UPDATE_BORROWER = "UPDATE borrowers SET BK_BORROWED = BK_BORROWED + 1 WHERE BOR_ID=?";
        ...
        if (bkid.getText().equals("") || bkname.getText().equals("") || borid.getText().equals("") || borname.getText().equals("") || borcontact.getText().equals("")) {
            ...
            try {
                ...
                psUpdateBorrower = con.prepareStatement(SQL_UPDATE_BORROWER);
                ...
                if (QTY.equals("0")) {
                    ...
                    // setting data in Borrower update SQL query
