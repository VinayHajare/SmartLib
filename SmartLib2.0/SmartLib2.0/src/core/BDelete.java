...
public class BDelete extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(borid, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 80, 201, 32));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        final String SQL = "DELETE FROM borrowers WHERE BOR_ID =?";
        Connection con = null;
        ...
        if(borID.equals("")){
            ...
            try {                
                ...
                try (Statement st = con.createStatement()) {
                    rs = st.executeQuery("SELECT * FROM borrowers WHERE BOR_ID = '" + borID + "'");
                }
                rs.close();
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(this, "Record of borrower with ID " + borID + " does not exist !", "ERROR", JOptionPane.INFORMATION_MESSAGE);
                }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
               ...
               ImageIcon img = new ImageIcon(getClass().getResource("/assets/delete-borrower-icon.png"));
               j1.setIconImage(img.getImage());
               j1.setTitle("Delete Borrower Record");
               j1.setVisible(true);
            }
        });
    }
