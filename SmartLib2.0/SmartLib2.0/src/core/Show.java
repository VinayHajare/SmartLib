...
public class Show extends javax.swing.JFrame {
     ...
     */
    public Show(int selectedTabIndex){
        initComponents();
        // Set the selected tab index
        if (selectedTabIndex >= 0 && selectedTabIndex < jTabbedPane1.getTabCount()) {
            jTabbedPane1.setSelectedIndex(selectedTabIndex);
        }
    }
    
    private void available_download() {
        ...
        if (path != null) {
            try {
                ...
                addTableHeader(tbl, new String[]{"Book Id", "Name", "Author", "Publication", "Price", "Quantity"});
                addTableData(tbl, t1);
                doc.add(tbl);
    ...
    private void issued_download() {
        ...
        if (path != null) {
            try {
                ...
                addTableHeader(tbl, new String[]{"Book Id", "Book Name", "Borrower Id", "Borrower Name", "Borrower Contact", "Issued Date", "Returned Date"});
                addTableData(tbl, t2);
                doc.add(tbl);
                showSuccessMessage("File downloaded !!");
            } catch (FileNotFoundException | DocumentException ex) {
    ...
    private void borrowers_download() {
        String path = getDirectoryPath();
        if (path != null) {
            try {
                Document doc = new Document();
                ...
                doc.open();
                PdfPTable tbl = new PdfPTable(7);
                addTableHeader(tbl, new String[]{"Borrower Id", "Borrower Name", "Borrower Address", "Borrower Email", "Borrower Contact", "Books Borrowed", "Total Fine"});
                addTableData(tbl, t3);
                doc.add(tbl);
                showSuccessMessage("File downloaded !!");
            } catch (FileNotFoundException | DocumentException ex) {
    ...
    private void addTableData(PdfPTable table, JTable jTable) {
    ...
    private void handleException(Exception ex) {
        ...
        LoggerUtil.logError("An error occurred: " +ex.getMessage(), ex);
    }
    ...
    private void initComponents() {
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/close-btn.png"))); // NOI18N
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/close-btn.png"))); // NOI18N
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        tbl.setRowCount(0);  // Clear the table before loading data

        String SQL_SELECT_ISSUED_BOOKS = "SELECT * FROM issued_books";

        try (Connection con = Connect.dbconnection(); Statement st = con.createStatement(); ResultSet rs = st.executeQuery(SQL_SELECT_ISSUED_BOOKS)) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try (Connection con = Connect.dbconnection(); Statement st = con.createStatement(); ResultSet rs = st.executeQuery(SQL_SELECT_BOOKS)) {
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        String SQL_SELECT_BORROWERS = "SELECT * FROM Borrowers";

        try (Connection con = Connect.dbconnection(); Statement st = con.createStatement(); ResultSet rs = st.executeQuery(SQL_SELECT_BORROWERS)) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                ImageIcon img = new ImageIcon(getClass().getResource("/assets/show-books-icon.png"));
